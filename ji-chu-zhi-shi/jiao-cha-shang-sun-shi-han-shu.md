...
$$
\begin{array}{c}
D_{K L}(p \| q)=\sum_{j=1}^{n} p\left(x_{j}\right) \log p\left(x_{j}\right)-\sum_{j=1}^{n} p\left(x_{j}\right) \log q\left(x_{j}\right) \\
=-H(p(x))+H(p, q)
\end{array}
$$
...
![&#x56FE;3-10 &#x4E8C;&#x5206;&#x7C7B;&#x4EA4;&#x53C9;&#x71B5;&#x635F;&#x5931;&#x51FD;&#x6570;&#x56FE;](../.gitbook/assets/image%20%2873%29.png)
