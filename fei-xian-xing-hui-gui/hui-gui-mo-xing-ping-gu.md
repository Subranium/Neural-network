...
$$MAE={1 \over m} \sum\_{i=1}^m \lvert a\_i-y\_i \rvert \tag{1}$$
...
$$MAPE={100 \over m} \sum^m\_{i=1} \lvert {a\_i - y\_i \over y\_i} \rvert \tag{2}$$

#### 和方差

SSE（Sum Squared Error）。

$$SSE=\sum\_{i=1}^m \(a\_i-y\_i\)^2 \tag{3}$$
...
$$MSE = \frac{1}{m} \sum\_{i=1}^m \(a\_i-y\_i\)^2 \tag{4}$$
...
$$RMSE = \sqrt{\frac{1}{m} \sum\_{i=1}^m \(a\_i-y\_i\)^2} \tag{5}$$
...
$$R^2=1-\frac{\sum \(a\_i - y\_i\)^2}{\sum\(\bar y\_i-y\_i\)^2}=1-\frac{MSE\(a,y\)}{Var\(y\)} \tag{6}$$
